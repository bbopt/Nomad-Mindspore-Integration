...
gpuNumber = 0
evalScript = "python eval.py"
singleOutputBB ='outputBB.txt'
logAllFile = 'logAllOutputs.txt'

dataset_path='/local1/ctribes/mindspore/datasets-cifar10-bin/cifar-10-batches-bin'
epoch_size = 200

previousHistoryFileIsProvided = True
...
if __name__ == '__main__':
    ...
    syst_cmd += ' bash -c \'' 
    syst_cmd += ' CUDA_VISIBLE_DEVICES=' +str(gpuNumber) + ' ' + evalScript + ' --optimizer=' + args['optimizer']  \
                                                                     ...
                                                                     + ' --do_train --do_eval --num_classes=10' \
